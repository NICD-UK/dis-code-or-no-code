...
- Are you using the most appropriate tools?
- Are there opportunities for using code instead of low-code?
- Do a Data Skills project with us

## Thanks!

Enjoy the rest of the conference! :smiley: